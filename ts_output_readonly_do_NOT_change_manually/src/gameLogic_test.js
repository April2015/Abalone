describe("In Abalone", function () {
    ...
    it("moving 3 black marbles in a line from initial state is legal", function () {
        expectMoveOk(0, undefined, [{ setTurn: { turnIndex: 1 } },
            { set: { key: 'board', value: [
                        ['', '', '', '', 'W', '', 'W', '', 'O', '', 'B', '', 'B', '', '', '', ''],
                        ['', '', '', 'W', '', 'W', '', 'W', '', 'B', '', 'B', '', 'B', '', '', ''],
                        ['', '', 'O', '', 'W', '', 'W', '', 'O', '', 'B', '', 'B', '', 'O', '', ''],
    ...
    it("pushing a black marble off marble", function () {
        expectMoveOk(1, { board: [
            ...
            { set: { key: 'action', value: { isInline: true, direction: { row: 0, col: -2 },
                        selfMarbles: [{ row: 7, col: 11 }, { row: 7, col: 9 },
                            { row: 7, col: 7 }],
                        opponentMarbles: [{ row: 7, col: 5 }, { row: 7, col: 3 }] } } }]);
    });
    ...
    //      {set: {key: 'action', value: {isInline: true, direction:  {row: 1, col:1},
    //       selfMarbles: [{row: 2, col: 4}, {row: 3, col: 5}, {row: 4, col: 6}],
    //       opponentMarbles: [{row: 6, col: 8}, {row: 5, col: 7}]}}},
    //     {set: {key: 'state', value: {board: [
    //       ['', '', '', '', 'O', '', 'O', '', 'B', '', 'O', '', 'O', '', '', '', '' ],
    //       ['', '', '', 'O', '', 'O', '', 'B', '', 'O', '', 'B', '', 'B', '', '', '' ],
    //       ['', '', 'O', '', 'O', '', 'O', '', 'W', '', 'O', '', 'O', '', 'O', '', '' ],
    ...
    //      {set: {key: 'action', value: {isInline: true, direction:  {row: 1, col:1},
    //       selfMarbles: [{row: 2, col: 4}, {row: 3, col: 5}, {row: 4, col: 6}],
    //       opponentMarbles: [{row: 5, col: 7}, {row: 7, col: 3}]}}},
    //     {set: {key: 'state', value: {board: [
    //       ['', '', '', '', 'O', '', 'O', '', 'B', '', 'O', '', 'O', '', '', '', '' ],
    //       ['', '', '', 'O', '', 'O', '', 'B', '', 'O', '', 'B', '', 'B', '', '', '' ],
    //       ['', '', 'O', '', 'O', '', 'O', '', 'W', '', 'O', '', 'O', '', 'O', '', '' ],
